...
class BasePlayer(ABC):
    ...
    def _get_default_system_prompt(self) -> str:
        ...
        return """You are the most aggresive talented and skilled professional No limit Texas Holdem poker player, evaluating the current game state and making the decision to fold, check, call, or raise to win as much money as possible.         
